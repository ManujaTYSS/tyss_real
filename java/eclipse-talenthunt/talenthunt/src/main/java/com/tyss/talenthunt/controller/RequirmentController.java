...
//	}
	...
	public Response getAllCandidate(HttpServletRequest request) {
		...
		List<CandidateCreation> candidate = service.getAllCandidate();
		if (candidate != null) {
			response.setStatusCode(200);
			response.setMessage("Success");
			response.setCandidate1(candidate);
			return response;
		} else {
			response.setStatusCode(400);
			response.setMessage("Failure");
	...
	public Response scheduleInterviewBean(@RequestBody ScheduleInterviewBean scheduleInterview) {
           Response response = new Response();
		...
		if (interview != null) {
			...
			response.setStatusCode(400);
			response.setMessage(" interview  scheduling is failed");
			return response;
		}
	}
	...
	@ResponseBody
	public Response getAllInterview(HttpServletRequest request) {
		Response response = new Response();
		...
		if (interview != null) {
			response.setStatusCode(200);
			response.setMessage("Success");
			response.setInterview1(interview);
			return response;
		} else {
			response.setStatusCode(400);
			response.setMessage("Failure");
